...
class PretrainedModel(nn.Module):
    ...
    def forward(self, x):
        ...
        time_features = self.avg_pool(time_enc3).squeeze(-1) 
        ...
        freq_features = self.avg_pool(freq_enc3).squeeze(-1) 
...
class FineTuningModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x_normalized = x_normalized.reshape(x_normalized.size(0), -1) 
